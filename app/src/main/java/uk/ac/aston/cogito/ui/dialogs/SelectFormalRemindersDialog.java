...
public class SelectFormalRemindersDialog extends FormBottomDialog {

    private NumberPicker remindersPicker;

    public SelectFormalRemindersDialog(BottomDialogListener listener, @NonNull Context context) {
    ...
    protected void initializeForm() {
        ...
        titleTextView.setText(R.string.dialog_numformal_title);

        // Set the subtitle
        TextView subtitleTextView = findViewById(R.id.subtitle);
        subtitleTextView.setText(R.string.dialog_numformal_subtitle);
